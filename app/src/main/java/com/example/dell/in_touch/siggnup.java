...
public class siggnup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_siggnup);
    ...
    public void signup (View v)
    {
        ...
        JsonObjectRequest signreq = new JsonObjectRequest("htttp://192.168.0.26/signup.php", signj, new Response.Listener<JSONObject>() {
            @Override
