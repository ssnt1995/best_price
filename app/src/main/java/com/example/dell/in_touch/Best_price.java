package com.example.dell.in_touch;
...
EditText email,password;
    ...
    public void login(View v)
    {
        ...
        JsonObjectRequest jobjreq = new JsonObjectRequest("http://192.168.0.26/login.php", jobj, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                ...
                try {
                    if(response.getString("key").equals("done"))
                    {
                        ...
                        Intent i = new Intent(Best_price.this , Homepage.class);
                        startActivity(i);
                        finish();
                    }
